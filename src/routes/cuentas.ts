...
import{getCuentas, postCuenta, updateCuentas, habilitarCuenta, deshabilitarCuenta, getCuentasActivas, gettotalCuentas, getCuentasInactivas, } from "../controllers/cuentas";
...
router.get('/inactivas',checkJwt,getCuentasInactivas);
